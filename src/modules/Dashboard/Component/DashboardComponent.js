              ...
              <div class="card-body">
                ...
                <div class="row mt-4 mb-3">
                  <div class="col-6 d-flex justify-content-end">
                    <div>
                      <label class="d-flex align-items-center justify-content-end tx-10 text-uppercase font-weight-medium">
                        Total storage{" "}
                        <span class="p-1 ml-1 rounded-circle bg-primary-muted"></span>
                      </label>
                  ...
                  <div class="col-6">
                    <div>
                      <label class="d-flex align-items-center tx-10 text-uppercase font-weight-medium">
                  ...
                  <table class="table table-hover mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>31/12/2021</td>
                        <td>
                          <span class="badge badge-danger-muted text-white">
                            Coming soon
                          </span>
                        </td>
                        <td>Yaretzi Mayo</td>
