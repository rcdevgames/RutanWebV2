...
import DetailServiceTransactionComponent from "../Component/IdentificationCompnent";
import {
  FileImageOutlined,
...
import * as DetailServiceActions from "../Store/IdentificationActions";
...
const IdentificationContainer = (props) => {
  const {
